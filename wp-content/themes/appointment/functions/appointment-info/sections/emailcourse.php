 ...
 */
?>
<div id="trustworthy_website" class="appointment-tab-pane">

	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<h1 class="appointment-info-title text-center"><?php echo __('Trustworthy Websites Details','appointment'); ?><?php if( !empty($appointment['Version']) ): ?> <sup id="appointment-theme-version"><?php echo esc_attr( $appointment['Version'] ); ?> </sup><?php endif; ?></h1>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
			...
			<div class="media pricing-content text-center padding10">
				<div class="media-body">
					<a href="<?php echo 'http://webriti.com/website-email-course/';?>" target="_blank" class="btn btn-info btn-lg" id="email_course"><?php esc_html_e('JOIN COURSE','appointment' ); ?></a>
				</div>
			</div>
		</div>
		</div>
